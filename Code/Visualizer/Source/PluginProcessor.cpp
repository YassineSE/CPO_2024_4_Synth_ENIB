...
//==============================================================================
const juce::String VisualizerAudioProcessor::getName() const
{
...
const juce::String VisualizerAudioProcessor::getProgramName (int index)
{
    return {};
}

void VisualizerAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void VisualizerAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* VisualizerAudioProcessor::createEditor()
{
    return new VisualizerAudioProcessorEditor (*this);
}

//==============================================================================
void VisualizerAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
